                 ...
                 //           viewHolder.noteCard.setOnClickListener(new View.OnClickListener() {
                   //             @Override
                     //           public void onClick(View view) {
                       //             Intent intent = new Intent(SaveNoteActivity.this, NewNoteActivity.class);
   ...
   // }
    ...
    private void updateUI(){
        ...
        if (fAuth.getCurrentUser() != null){
            ...
            Intent startIntent = new Intent(SaveNoteActivity.this, SelectiveActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.main_new_note_btn:
                Intent newIntent = new Intent(SaveNoteActivity.this, NewNoteActivity.class);
