...
import com.example.speechapp.adapters.UserProfilesMenuAdapter;
...
public class ChatActivity extends AppCompatActivity implements UserProfilesMenuAdapter.ListItemClickListner {
    static {
//        FirebaseDatabase.getInstance().setPersistenceEnabled(false);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mUsersDatabaseReference = mFirebaseDatabase.getReference().child("Registeration");
        ...
        menuAdapter = new UserProfilesMenuAdapter(userList, ChatActivity.this);
